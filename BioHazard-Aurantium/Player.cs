...
namespace BioHazard_Aurantium
{
    class Player
    {
        ...
        public void Initialise()
        {
            ...
            // Melee //
            weapons[8] = "BROADSWORD";

            //************************LEGENDARY WEAPONS************************//

            // Pistol //
            weapons[9] = "FIVESEVEN - Legendary";

            // Assault //
            weapons[10] = "AK47 - Legendary";
            weapons[11] = "FAMAS - Legendary";
            weapons[12] = "M4A1 - Legendary";


            // Submachine //
            weapons[13] = "P90 - Legendary";

            // Melee //
            weapons[14] = "ABYSSWALKER - Legendary";


            //************************SOUND************************//

            // Setting sounds //
            player_audio[0] = new SoundPlayer(Properties.Resources.DeathSound);
            ...
            //************************IMAGES************************//
                ...
                {
                    for (int animationnumber = 0; animationnumber < 47; animationnumber++)
                    {
                        animations[(46 * setnumber) + animationnumber].frames = new List<Bitmap>();
                        ...
                        {
                            //Loads the image //
                            animations[(46 * setnumber) + animationnumber].frames.Add(new Bitmap(imagepath + setnumber + "/" + animationnumber + "/" + framenumber + ".png"));
                        }
                    }
                }
        ...
        animation_frames[] animations = new animation_frames[369];
        ...
        {
            if (frame < animations[(46 * direction) + animation].frames.Count)
            {
                frame++;
            }
            else
        ...
        {
            return animations[(46 * direction) + animation].frames[frame];
        }
        ...
        public void change_weapon(byte weaponslot)
        {
            ...
            switch (weapons[currentweapon])
            {
                ...
                case "FIVESEVEN - Legendary":
                    {
                        currentweaponanimationnumber = 2;
                    }
                    break;
            }
        }
        ...
        public void play_Sound(int soundposition, int volume)
        {
            ...
            player_audio[soundposition].Play();
        }

        // Creates sound players //
        SoundPlayer[] player_audio = new SoundPlayer[5];
